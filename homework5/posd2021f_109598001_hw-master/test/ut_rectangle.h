...
TEST_F(RectangleTest, CreateIteratorNoException){
    Iterator* it = rec->createIterator();
    // Expected
...
TEST_F(RectangleTest, InfoRoundingUpIsCorrect){
    Shape* r = new Rectangle(10.225, 11.232);
    // Expected
    ASSERT_EQ(r->info(), "Rectangle (10.23 11.23)");
    delete r;
}
